...
urlpatterns = patterns('',
    ...
    url(r'^share/badge$', views.sharebadge, name='mobile.sharebadge'),
    ...
    url(r'^boost1_complete$', views.boost1_complete, name='mobile.boost1_complete'),
    url(r'^yourlocation$', views.geolocation_fallback, name='mobile.yourlocation'),
    url(r'^boost2$', views.boost2, name='mobile.boost2'),
    url(r'^boost2_confirm$', views.boost2_confirm, name='mobile.boost2_confirm'),
    url(r'^user/(?P<username>[\w.@+-]+)$', views.user, name='mobile.user'),
