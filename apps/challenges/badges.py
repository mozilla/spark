...
badges = {
    ...
    'lvl1_ch1': _lazy(u'Spark Starter'),
    ...
    'lvl1_ch3': _lazy(u'TBD'),

    # L10n: Badge title for challenge: "Obtain a share from Facebook"
    'lvl2_ch1': _lazy(u'TBD'),
    # L10n: Badge title for challenge: "Obtain a share from Twitter"
    'lvl2_ch2': _lazy(u'Tweet Treat'),
    # L10n: Badge title for challenge: "Log in on both your phone and your desktop web browser"
    'lvl2_ch3': _lazy(u'Double Down'),
    ...
    'lvl2_ch5': _lazy(u'100 Mile Dash'),
    ...
    'ee_ch9': _lazy(u'Race Against Time'),
    # L10n: Badge title for challenge: "Share your Spark with someone on an island (Hawaii, Japan, etc)". If it doesn't translate well, translate "Island Hopper".
    'ee_ch10': _lazy(u'The Gilligan'),
    # L10n: Badge title for challenge: "Share your Spark to someone in a French-speaking country"
    'ee_ch11': _lazy(u'Ooo La Lumière'),
    ...
    'ee_ch19': _lazy(u'The Ace of Sparks'),
}
